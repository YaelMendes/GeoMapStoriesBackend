...
This guide walks you through the process of creating a "main.hello world" link:/understanding/REST[RESTful web service] with Spring.
...
`src/main/java/main.hello/Greeting.java`
[source,java]
----
include::complete/src/main/java/main.hello/Greeting.java[]
----
...
`src/main/java/main.hello/GreetingController.java`
[source,java]
----
include::complete/src/main/java/main.hello/GreetingController.java[]
----
...
`src/main/java/main.hello/Application.java`
[source,java]
----
include::complete/src/main/java/main.hello/Application.java[]
----
